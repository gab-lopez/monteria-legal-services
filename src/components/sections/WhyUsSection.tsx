...
import { ShieldCheck, Users, Award, BookOpen, Handshake } from "lucide-react";
...
export default function WhyUsSection() {
  return (
    <section className="py-16 sm:py-20 bg-white scroll-mt-20" id="por-que-elegirnos">
            ...
            {reasons.map((reason, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group p-6 border border-slate-200 hover:border-[#b08600] hover:shadow-md transition-all duration-300 ${isLast ? "sm:col-span-2" : ""}`}
                >
